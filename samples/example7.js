...
const bundlesTest = [
  ['samples/templates/dcterms.json'],
  ['samples/templates/foaf.json'],
  ['samples/templates/skos.json'],
  ['samples/templates/adms.json'],
  ['samples/templates/vcard.json'],
  ['samples/templates/dcat_props.json'],
  ['samples/templates/dcat.json'],
];
